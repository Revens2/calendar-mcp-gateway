"""Page de consentement du flux OAuth de la passerelle Calendar.
...
from calendar_gateway.oauth import (
    PORTEE,
    PORTEE_ECRITURE,
    FournisseurOAuth,
    verifier_phrase,
...
VARIABLE_EMPREINTE = "CALENDAR_MCP_CONSENT_HASH"

_GABARIT = """<!doctype html>
<html lang="fr"><head><meta charset="utf-8">
<meta name="viewport" content="width=device-width,initial-scale=1">
<title>Autoriser l'acces a Google Calendar</title>
<style>
...
<h1>Autoriser l'acces a vos calendriers Google</h1>
<p>Le client <strong>{client}</strong> demande les acces suivants a vos calendriers
Google. Saisissez votre phrase de passe pour autoriser cette connexion.</p>
...
_LIBELLES = {
    PORTEE: ("Lire", "vos calendriers Google (listes, evenements, disponibilites)"),
    PORTEE_ECRITURE: ("Creer et modifier", "des evenements dans vos calendriers Google"),
}

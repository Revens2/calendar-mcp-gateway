"""Point d'entree de la passerelle Calendar (`python -m calendar_gateway.server`).

Ecoute sur la boucle locale uniquement : nginx (site `calendar-mcp`, 443 public) est le
...
from calendar_gateway.app import PORT_PAR_DEFAUT, _config, construire_application
